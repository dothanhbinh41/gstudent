...
class VocabSecondChallenge extends StatefulWidget {
  int page;
  int classroomId;
  int lesson;
  int testId;
  ...
  @override
  State<StatefulWidget> createState() => VocabSecondChallengeState(
...
class VocabSecondChallengeState extends State<VocabSecondChallenge> {
  List<Vocab> listWords;
  int classroomId;
  int lesson;
  int testId;
