...
class StealEncourageView extends StatefulWidget {


  @override
  State<StatefulWidget> createState() => StealEncourageViewState();
}

class StealEncourageViewState extends State<StealEncourageView>
                        ...
                        Positioned(
                          child: Column(
                            ...
                            children: [
                              ...
                              Center(
                                child: Text(
                                      'Mỗi thành viên trong team bạn sẽ được nhận 10HP và 5 vàng'  ,
                                  style: TextStyle(
                                      fontSize: 14,
...
class EncourageSuccess extends StatelessWidget {
  EncourageSuccess(
      {Key key,
        this.controller,
        this.heightItem,
